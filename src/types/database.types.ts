  ...
  public: {
    Tables: {
      ...
      pickup_order_images: {
        ...
        Relationships: [
          {
            foreignKeyName: "pickup_order_images_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "pickup_orders"
            referencedColumns: ["id"]
      ...
      pickup_order_items: {
        Row: {
          ...
          unit: Database["public"]["Enums"]["scrap_unit"]
        }
        Insert: {
          created_at?: string
          estimated_quantity?: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "pickup_order_items_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "pickup_orders"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pickup_order_items_scrap_category_id_fkey"
            columns: ["scrap_category_id"]
            isOneToOne: false
      ...
      pickup_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "pickup_orders_address_id_fkey"
            columns: ["address_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "pickup_orders_seller_id_fkey"
            columns: ["seller_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      scrap_prices: {
        ...
        Relationships: [
          {
            foreignKeyName: "scrap_prices_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "scrap_prices_scrap_category_id_fkey"
            columns: ["scrap_category_id"]
            isOneToOne: false
            referencedRelation: "scrap_categories"
            referencedColumns: ["id"]
